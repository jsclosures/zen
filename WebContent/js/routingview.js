function buildRoutingViewPage(mainContext, mainId,currentChild) {
	...
	require([
         ...
         function(){
        	 ...
        	 internalBuildRoutingViewPage(mainContext, mainId);
...
function internalBuildRoutingViewPage(mainContext, mainId) {
                    ...
                    if( response.items ){
                        ...
                        for(var i = 0;i < response.items.length;i++){
                            ...
                            var newItem = {id: item.id,
                                            label: item.sequence + " " + item.mode + " " + item.className + " " + item.target,
                                            actualRecord: item,
